 ...
 <div id="content">
   <div id="content-header">
     <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
       <a href="http://localhost/absensi_siswa/petugas_piket/jamngajar" class="current">Jam Ngajar</a></div>
     <h1>Jam Mengajar</h1>
   </div>
   <div class="container">
     <div class="span11">
     ...
     <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="table-responsive">
              <form method="post"action="http://localhost/absensi_siswa/petugas_piket/proses.php?kategori=absen_jam_ngajar&id=<?PHP echo $_GET['id_guru']; ?>">
