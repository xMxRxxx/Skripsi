 ...
 <div id="content">
   <div id="content-header">
     <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
       <a href="http://localhost/absensi_siswa/petugas_piket/jamngajar" class="current">Jam Ngajar Guru</a> </div>
     <h1>Jam Mengajar</h1>
   </div>
   <div class="container">
   <div class="span7">
            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <?php
                  if (isset($_GET['bulan'])) {
                    echo "<a href='http://localhost/absensi_siswa/petugas_piket/jamngajar/$data[id_guru]/$_GET[tahun]/$cari_bulan_guru/'>$data[nama]</a>";
                  }else {
                    $cari_bulan_guru=date('m');
                    $tahun=date('Y');
                    echo "<a href='http://localhost/absensi_siswa/petugas_piket/jamngajar/$data[id_guru]/$tahun/$cari_bulan_guru/'>$data[nama]</a>";
                  }
                  ?></td>
                  <?php
                  $nomor2=1;
