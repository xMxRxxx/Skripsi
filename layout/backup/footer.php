...
<?php $actual_link = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
  if ($actual_link=="http://localhost/absensi_siswa/petugas_piket/index.php"
    or $actual_link=="http://localhost/absensi_siswa/kesiswaan/index.php"
    or $actual_link=="http://localhost/absensi_siswa/koordinator/index.php"
    or $actual_link=="http://localhost/absensi_siswa/wali_kelas/index.php") {
?>
<script src="http://localhost/absensi_siswa/js/jquery.min.js"></script>
<script src="http://localhost/absensi_siswa/js/bootstrap.min.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.flot.min.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.flot.resize.min.js"></script>
...
$(function () {
  ...
  if (isset($_SESSION['id_kelas'])) {
   ...
   ?>
    ...
    <?php if ($actual_link=="http://localhost/absensi_siswa/petugas_piket/index.php"
    or $actual_link=="http://localhost/absensi_siswa/koordinator/index.php") {?>
    var datasets2 = {
        "izin2": {
            label: "IZIN",
...
<script src="http://localhost/absensi_siswa/js/jquery.min.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.ui.custom.js"></script>
<script src="http://localhost/absensi_siswa/js/bootstrap.min.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.uniform.js"></script>
<script src="http://localhost/absensi_siswa/js/select2.min.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.dataTables.min.js"></script>
<script src="http://localhost/absensi_siswa/js/matrix.js"></script>
<script src="http://localhost/absensi_siswa/js/matrix.tables.js"></script>
<script src="http://localhost/absensi_siswa/js/bootstrap-colorpicker.js"></script>
<script src="http://localhost/absensi_siswa/js/bootstrap-datepicker.js"></script>
<script src="http://localhost/absensi_siswa/js/masked.js"></script>
<script src="http://localhost/absensi_siswa/js/matrix.form_common.js"></script>
<script src="http://localhost/absensi_siswa/js/jquery.peity.min.js"></script>
