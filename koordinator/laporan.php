...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi_siswa/koordinator/laporan" class="tip-bottom">Guru</a> <a href="http://localhost/absensi_siswa/koordinator/laporan" class="current">Laporan Absen</a> </div>
