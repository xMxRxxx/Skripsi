    ...
    <div>
      <div style="width: 100%;">
        <table cellspacing="0"style="width: 100%;">
          <tr>
            <td style="width: 15%;"><img src="http://localhost/absensi_siswa/img/<?PHP echo $header_photo['photo']; ?>"style="width: 100%;"></td>
            ...
            <td style="width: 15%;"><img src="http://localhost/absensi_siswa/img/tut.png"style="width: 100%;"></td>
          </tr>
        </table>
