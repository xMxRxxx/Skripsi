...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi_siswa/admin/guru" class="tip-bottom"> Guru</a>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensi_siswa/admin/proses.php?hapus_guru=<?PHP echo $data['id_guru']?>"class="btn btn-info">Ya</a></td>
