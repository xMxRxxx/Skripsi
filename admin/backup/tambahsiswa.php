<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/absensi_siswa/admin/siswa" class="tip-bottom">Siswa</a>
     <a href="http://localhost/absensi_siswa/admin/siswa/add" class="current">Tambah</a> </div>
   <h1>Tambah Siswa</h1>
 </div>
       ...
       <div class="widget-box">
         ...
         <div class="widget-content nopadding">
           <form action="../proses.php?kategori=siswa" method="post" class="form-horizontal">
             ...
             <div class="control-group">
               <label class="control-label">Tahun Pendaftaran:</label>
               <div class="controls">
                 <input type="text" class="span11" placeholder="Tahun Pendaftaran"name="thn_pendaftaran" />
               </div>
             </div>
