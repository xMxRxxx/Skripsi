...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensi_siswa/admin/Pelajaran" class="tip-bottom"> pelajaran</a>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensi_siswa/admin/proses.php?hapus_pelajaran=<?PHP echo $data['id_pelajaran']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="http://localhost/absensi_siswa/admin/pelajaran/"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
