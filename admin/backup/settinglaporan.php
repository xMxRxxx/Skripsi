<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/absensi_siswa/admin/settinglaporan" class="current">Setting Laporan</a> </div>
         ...
         <div class="widget-content nopadding">
           ...
           <form action="./proses.php?edit_laporan" method="post" class="form-horizontal"enctype="multipart/form-data">
             <div class="control-group">
               <label class="control-label">Nama Kepala SMKN 1 PASAMAN:</label>
               <div class="controls">
                 <input type="text" class="span11" placeholder="Nama Kepala SMKN 1 PASAMAN"name="nama_ketua"
                 value="<?php echo $data['nama_ketua']; ?>" />
               </div>
             </div>
             <div class="control-group">
               <label class="control-label">Nama Wakil SMKN 1 PASAMAN :</label>
               <div class="controls">
                 <input type="text" class="span11" placeholder="Nama Wakil SMKN 1 PASAMAN"name="nama_wakil"
