<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/absensi_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/absensi_siswa/admin/jamngajar" class="tip-bottom">Jam Ngajar</a>
    <a href="http://localhost/absensi_siswa/admin/jamngajar/add" class="current">Tambah</a> </div>
