            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/absensi_siswa/admin/proses.php?hapus_siswa=<?PHP echo $data['id_siswa']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="http://localhost/absensi_siswa/admin/guru/"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
