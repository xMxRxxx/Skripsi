 ...
 <div id="content" style="margin-top:60px;">
  <div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
      <div class="content text-center">
        ...
        <a class="btn btn-outline-info active" style="margin: 5px; color:white; border-color: #0099cc; background: #0099cc: ;" href="http://localhost/absensi_siswa/siswa/kelasberlangsung.php" role="button">MASUK KELAS SEKARANG</a>
                  ...
                  <div class="row justify-content-center" style="align-content: center;">
                      <div class="col-lg-2 mt-4">
                          <div class="card servicesText">
                            <div class="content text-center">
                              <img src="http://localhost/absensi_siswa/img/tut.png" width="100px" class="text-center"/>
